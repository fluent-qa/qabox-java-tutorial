...
public interface SQLite {
	...
	public final static String SQLITE_DERVER = "org.sqlite.JDBC";
	...
	/** SQLite数据类型unsigned big int */
	public final static String UNSIGNED_BIG_INT = "UNSIGNED BIG INT";
	/** SQLite数据类型int2 */
